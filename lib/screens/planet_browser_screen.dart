...
class _PlanetBrowserScreenState extends State<PlanetBrowserScreen> {
        ...
        return Scaffold(
          appBar: AppBar(
            ...
            actions: [
              ...
              if (!planetProvider.isUsingMockData &&
                  planetProvider.cacheStats['indexedDBCount'] != null &&
                  planetProvider.cacheStats['indexedDBCount'] > 0)
                Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Text(
                        'Cached (${planetProvider.cacheStats['indexedDBCount']})',
                        style: TextStyle(
                          color: Colors.green,
                          fontSize: 12,
              ...
              // Show offline mode indicator for mock data
              if (planetProvider.isUsingMockData)
                Container(
                  margin: const EdgeInsets.only(right: 8),
                  padding: const EdgeInsets.symmetric(
              ...
              IconButton(
                ...
                onPressed: _navigateToCitizenScience,
                tooltip: 'Citizen Science',
              ),
              IconButton(
                icon: const Icon(Icons.info_outline),
                onPressed: () => _showInfoDialog(
                  planetProvider.totalCount,
                  planetProvider.isUsingMockData,
                ),
              ),
            ],
          ),
  ...
  void _navigateToCitizenScience() {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => const CitizenScienceScreen()),
    );
  }

  void _showInfoDialog(int totalCount, bool isUsingMockData) {
    showDialog(
      context: context,
        ...
        content: SingleChildScrollView(
          child: Column(
            ...
            children: [
                ...
                Container(
                  ...
                  child: Row(
                    children: [
                      ...
                      Expanded(
                        child: Text(
                          'Running in offline mode with sample data. NASA API unavailable.',
                          style: TextStyle(
                            color: AppTheme.warningColor,
                            fontSize: 12,
                          ),
              ...
              Text(
                isUsingMockData
                    ? 'Exploring $totalCount sample exoplanets with realistic data.'
              ...
              Consumer<PlanetProvider>(
                builder: (context, provider, child) {
                  final cacheCount = provider.cacheStats['indexedDBCount'] ?? 0;
                  final lastUpdated =
                      provider.cacheStats['indexedDBLastUpdated'];
                  ...
                  return Column(
                    ...
                    children: [
                      Text(
                        isUsingMockData
                            ? 'Data Source: Sample Database (Offline)'
                      ...
                      if (cacheCount > 0) ...[
                        ...
                        Row(
                          children: [
                            ...
                            const SizedBox(width: 4),
                            Text(
                              '$cacheCount planets cached locally',
                              style: const TextStyle(
                                color: Colors.green,
                                fontSize: 12,
                                fontWeight: FontWeight.w600,
